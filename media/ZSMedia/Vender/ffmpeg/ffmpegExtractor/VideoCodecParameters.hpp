...
#ifndef VideoCodecParameters_hpp
#define VideoCodecParameters_hpp
...
public:
    ...
    VideoCodecParameters(MZCodecIDType type, int width,int height,MZPixelFormat pixelformat,int fps,int brate,int gopsize,int bframes);
...
#endif /* VideoCodecParameters_hpp */
