 ...
 */
@interface VideoEnDecodeViewController ()<AVCaptureVideoDataOutputSampleBufferDelegate>
{
...
@property (strong, nonatomic) AudioDataWriter           *mDataWriter;
@end

@implementation VideoEnDecodeViewController
...
- (void)viewDidLoad {
    ...
    self.mDataWriter = [[AudioDataWriter alloc] initWithPath:file];
